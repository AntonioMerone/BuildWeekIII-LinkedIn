...
const Education = () => {
  return (
    <Card className="education-card mt-2">
      <Card.Body>
        <div className="education-header">
          <h3 className="education-title">Formazione</h3>
          <Button variant="link" className="education-close-btn">
            <FaTimes />
          </Button>
        </div>
        ...
        <EducationItem
          school="Scuola o università"
          degree="Laurea, campo di studi"
          period="2019 - 2023"
        />

        <Button variant="outline-primary" className="education-add-btn">
