...
const Activity = ({ followers = 0 }) => {
  return (
    <Card className="activity-card mt-2">
      <Card.Body>
        <div className="activity-header">
          <div className="activity-title-section">
            <h3 className="activity-title">Attività</h3>
            <a href="#" className="activity-followers">
              {followers} follower
            </a>
          </div>
          <div className="activity-actions">
            <Button variant="outline-primary" className="activity-create-btn">
              Crea un post
            </Button>
            <Button variant="link" className="activity-edit-btn">
              <FaPencilAlt />
            </Button>
          </div>
        </div>
