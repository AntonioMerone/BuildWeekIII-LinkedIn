    ...
    <Card className="experience-card">
      <Card.Body>
        <div className="experience-header">
          ...
          <Button variant="link" className="experience-close-btn"><FaTimes /></Button>
        </div>
        ...
        <ExperienceItem title="Qualifica" company="Organizzazione" period="2023 - Presente" />
        
        <Button variant="outline-primary" className="experience-add-btn">Aggiungi esperienza</Button>
      </Card.Body>
    </Card>
  );
};
